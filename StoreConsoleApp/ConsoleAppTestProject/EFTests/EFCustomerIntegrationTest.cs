...
{
    public class EFCustomerIntegrationTest
    {
        [Fact]
        public void Add_Customer_Will_Return_True()
        {
            ICustomerDataAccess customerDataAccess = new EFCustomerDataAccess();
        ...
        {
            ICustomerDataAccess customDataAccess = new EFCustomerDataAccess();
